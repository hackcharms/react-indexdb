            ...
            <div className="flex w-full items-start px-3  md:w-full">
              ...
              <div className="-mr-1">
                <button
                  type="button"
                  onClick={storeTodo}
                  className="mb-2 me-2 inline-flex items-center rounded-lg bg-motion-secondary px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-motion-secondary/90 focus:outline-none focus:ring-4 focus:ring-motion-secondary/50 dark:focus:ring-motion-secondary/55"
                >
                  <svg
